...
function ChildProfilePage() {
  ...
  return (
    <>
      ...
      <div
        className="bg-cover"
        style={{ backgroundImage: 'url("/src/assets/mamaBaby.jpg")' }}
      >
        <div className="flex items-center justify-center h-screen ">
          ...
          <div className="w-full max-w-2xl bg-[#FFD9B7] border border-[#FFD9B7] rounded-lg shadow">
            ...
            <div className="flex flex-col items-center pb-10">
              ...
              <h5
                id="child-name"
                className="mb-1 text-xl font-medium font-[Mont] text-black"
              >
